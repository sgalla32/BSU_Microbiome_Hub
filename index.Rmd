---
title: "Welcome to the Microbiome Hub at Boise State University"
output:
...
$(document).ready(function() {
  $('#header').parent().prepend('<div id=\"logo\"><img src=\"Images/Microbiome_Hub.png\" style=\"position:absolute; top:0; right:0; padding:10px; height:120px\"></div>');
